              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  @if ( $query_params = Request::input('q') )
                      ...
                      <li class="breadcrumb-item active"><a href="{{ route('userPermissions.index') }}">{{ $model_title_list['userPermissions'] }}</a></li>
                  ...
                  @else
                      <li class="breadcrumb-item active">{{ $model_title_list['userPermissions'] }}</li>
                  @endif
              ...
              <div class="card">
                  <div class="card-body">
                      <h1 class="d-flex mb-3">
                          ...
                          <span class="d-inline-block">{{ $model_title_list['userPermissions'] }}</span>
                          <a class="btn btn-success d-inline-flex ml-auto" href="{{ route('userPermissions.create') }}"><i class="material-icons align-self-center mr-1">add_circle</i><span class="align-self-center">Create</span></a>
                      </h1>
                      ...
                      <div class="collapse mb-4" id="search-area">
                        <div class="card card-body">
                          ...
                          <form id="search" action="{{ route('userPermissions.index') }}" accept-charset="UTF-8" method="get">
                      ...
                      @include('userPermissions._table')
                  </div>
              </div>
          </div>
      </div>
