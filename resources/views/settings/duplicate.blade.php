              ...
              <div class="card">
                  <div class="card-body">
                      ...
                      <h1 class="d-flex mb-3">
                          ...
                          <span class="d-inline-block">{{ $model_title_list['settings'] }} / Duplicate #{{$setting->id}}</span>
                      </h1> 

                      <div class="row">
                        <div class="col-md-12">
                          <form method="POST" action="{{ route('settings.store') }}" accept-charset="UTF-8" class="needs-validation" novalidate>

                            {{ csrf_field() }}

                            @include('settings._form', ['mode' => 'duplicate'])
