              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  @if ( $query_params = Request::input('q') )
                      ...
                      <li class="breadcrumb-item active"><a href="{{ route('userUserRoles.index') }}">{{ $model_title_list['userUserRoles'] }}</a></li>
                  ...
                  @else
                      <li class="breadcrumb-item active">{{ $model_title_list['userUserRoles'] }}</li>
                  @endif
              ...
              <div class="card">
                  <div class="card-body">
                      <h1 class="d-flex mb-3">
                          ...
                          <span class="d-inline-block">{{ $model_title_list['userUserRoles'] }}</span>
                          <a class="btn btn-success d-inline-flex ml-auto" href="{{ route('userUserRoles.create') }}"><i class="material-icons align-self-center mr-1">add_circle</i><span class="align-self-center">Create</span></a>
                      </h1>
                      ...
                      <div class="collapse mb-4" id="search-area">
                        <div class="card card-body">
                          ...
                          <form id="search" action="{{ route('userUserRoles.index') }}" accept-charset="UTF-8" method="get">
