              ...
              <div class="card">
                  <div class="card-body">
                      ...
                      <h1 class="d-flex mb-3">
                          ...
                          <span class="d-inline-block">{{ $model_title_list['settingGroups'] }} / Duplicate #{{$settingGroup->id}}</span>
                      </h1> 

                      <div class="row">
                        <div class="col-md-12">
                          <form method="POST" action="{{ route('settingGroups.store') }}" accept-charset="UTF-8" class="needs-validation" novalidate>

                            {{ csrf_field() }}

                            @include('settingGroups._form', ['mode' => 'duplicate'])
