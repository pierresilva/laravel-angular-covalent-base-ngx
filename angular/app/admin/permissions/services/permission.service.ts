...
export class PermissionService {
  ...
  public selectedItems: UserPermission[] = [];
  public item: UserPermission = <UserPermission>{};
  public model: UserPermission = <UserPermission>{};
  ...
  public setItem(item: UserPermission) {
    this.item = item;
  }
